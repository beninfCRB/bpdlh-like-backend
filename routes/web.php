...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('akseslh')->group(function () {
        ...
        // Import, Download and Unpublish
        Route::get('/email-blast/template-pivot-email-blast', [App\Http\Controllers\Cms\Akseslh\EmailBlastController::class, 'template'])->name('pivot.template.download');
        Route::post('/email-blast/import-pivot-email-blast', [App\Http\Controllers\Cms\Akseslh\EmailBlastController::class, 'importPivotData'])->name('pivot.import.upload');
        ...
        Route::get('/pengajuan-kegiatan/export-proposal/{id}', [App\Http\Controllers\Cms\Akseslh\PengajuanKegiatanController::class, 'export_proposal'])->name('export-proposal');
        ...
        Route::post('/transaksi-penyaluran/export-excel-transaksi-penyaluran', [App\Http\Controllers\Cms\Akseslh\TransaksiPenyaluranController::class, 'export'])->name('export-excel-transaksi-penyaluran');

        Route::get('/pic-kelompok-masyarakat/export-pic', [App\Http\Controllers\Cms\Akseslh\DataPicKelompokMasyarakatController::class, 'export'])->name('pic-kelompok-masyarakat.export');
        Route::post('/pic-kelompok-masyarakat/import', [App\Http\Controllers\Cms\Akseslh\DataPicKelompokMasyarakatController::class, 'import'])->name('pic-kelompok-masyarakat.import');
        ...
        Route::get('tolak-pengajuan-dan-profil/template', [App\Http\Controllers\Cms\Akseslh\TolakPengajuanDanProfilController::class, 'template'])->name('tolak-pengajuan-dan-profil.template');

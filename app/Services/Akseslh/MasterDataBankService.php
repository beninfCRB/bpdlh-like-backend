...
class MasterDataBankService extends AppService implements AppServiceInterface
{
    ...
    {
        $model = $this->model->query()->orderBy('id', 'ASC');
    ...
    public function create($data)
    {
        ...
        try {
            ...
            $master_data_bank = $this->model->newQuery()->create([
                'nama_bank' =>  $data['nama_bank'],
                'bank_code' =>  $data['kode_bank'],
            ]);

            \DB::commit(); // commit the changes
            return $this->sendSuccess($master_data_bank);
    ...
    public function update($id, $data)
    {
        ...
        try {
            ...
            $read->nama_bank    =   $data['nama_bank'];
            $read->bank_code    =   $data['kode_bank'];
            $read->save();

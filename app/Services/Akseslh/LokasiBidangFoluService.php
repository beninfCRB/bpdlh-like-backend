...
class LokasiBidangFoluService extends AppService implements AppServiceInterface
{

    public function __construct(LokasiBidangFolu $model)
    {
    ...
    public function getAllAttr()
    {
        ...
        $result->transform(function ($items, $key) {
            return [
                'id'                 => $items->id,
                'lokasi_bidang_folu'     => $items->lokasi_bidang_folu,
            ];
        });

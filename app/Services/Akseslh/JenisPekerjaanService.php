...
class JenisPekerjaanService extends AppService implements AppServiceInterface
{

    public function __construct(JenisPekerjaan $model)
    {
    ...
    public function update($id, $data)
    {
        ...
        try {
            ...
            $read->jenis_pekerjaan    =   $data['jenis_pekerjaan'];
            $read->save();

...
class Register2Request extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'provinsi_kelompok_masyarakat'              => 'required',
            'kabupaten_kelompok_masyarakat'             => 'required',
            'kecamatan_kelompok_masyarakat'             => 'required',
            'kelurahan_kelompok_masyarakat'             => 'required',

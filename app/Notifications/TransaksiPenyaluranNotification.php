...
class TransaksiPenyaluranNotification extends Notification
{
    use Queueable;
    ...
    public function toArray($notifiable)
    {
        return [
            //
            'message_header'    => 'Nomor permohonan: #' . $this->nomor_pengajuan . ' atas nama ' . $this->atas_nama . ', telah dilakukan pencairan sebesar Rp.' . number_format($this->sebesar) . '.',

...
@section('title', 'Buat Master Sub Tematik Kegiatan')
    ...
    <div class="col-md-6">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form role="form" action="{{ route('master-sub-tematik-kegiatan.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group @error('sub_tematik_kegiatan_id') has-error @enderror">
                        ...
                        <select name="sub_tematik_kegiatan_id" id="sub_tematik_kegiatan_id" class="form-control">
                            ...
                            @if (old('sub_tematik_kegiatan_id') == $item['id'])

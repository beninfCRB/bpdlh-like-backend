...
@section('title', 'Buat Log Masa Sanggah')
...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <h4 class="pull-left page-title">KELOLA DATA LOG MASA SANGGAH</h4>
            <ol class="breadcrumb pull-right">
                <li><a href="#">Data Master</a></li>
                <li><a href="#">Forms</a></li>
                <li class="active">Pengelolaan Data Log Masa Sanggah</li>
            </ol>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Pengelolaan Data Log Masa Sanggah</h3>
                </div>
                <div class="panel-body">
                    <form role="form" action="{{ route('log-masa-sanggah.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <a href="{{ route('log-masa-sanggah.index') }}"

                    ...
                    <div class="row">
                        ...
                        <div class="form-group @error('jenis_identitas_pic') has-error @enderror col-md-4">
                            ...
                            <select class="form-control" required id="jenis_identitas_pic" name="jenis_identitas_pic"
                                required>
                                <option class='form-control' value=''>- Pilih Data -</option>
                                <option class='form-control' value='KTP' {{ old('jenis_identitas_pic', $data->
                                    jenis_identitas_pic)=='KTP'
                                    ? 'selected' : '' }}>KTP
                                </option>
                                <option class='form-control' value='SIM' {{ old('jenis_identitas_pic', $data->
                                    jenis_identitas_pic)=='SIM'
                                    ? 'selected' : '' }}>SIM
                                </option>
                                <option class='form-control' value='Kartu Mahasiswa' {{ old('jenis_identitas_pic',
                                    $data->jenis_identitas_pic)=='Kartu Mahasiswa' ? 'selected' : '' }}>Kartu
                                    Mahasiswa</option>
                            </select>
                        ...
                        <div class="form-group @error('status_user') has-error @enderror col-md-4">
                            ...
                            <select class="form-control" required id="status_user" name="status_user" required>
                                <option class='form-control' value=''>- Pilih Data -</option>
                                <option class='form-control' value='ACTIVE' {{ old('status_user', $data->
                                    user_akseslh->status_user)=='ACTIVE'
                                    ? 'selected' : '' }}>ACTIVE
                                </option>
                                <option class='form-control' value='NON ACTIVE' {{ old('status_user', $data->
                                    user_akseslh->status_user)=='NON ACTIVE'
                                    ? 'selected' : '' }}>NON ACTIVE
                                </option>
                            </select>

                        ...
                        <form role="form" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="jenis_identitas_pic"
                                    ...
                                    value="{{ $data->data->data_pic_kelompok_masyarakat->jenis_identitas_pic }}" readonly>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nomor_identitas_pic"
                                    ...
                                    value="{{ $data->data->data_pic_kelompok_masyarakat->nomor_identitas_pic }}" readonly>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="kabupaten_pic">Kota/Kabupaten PIC <span class="text-danger">*</span></label>
                    ...
                    <div class="portlet-body">
                        <form role="form" method="POST">
                            ...
                            <div
                                ...
                                <label for="nomor_npwp_pic">Nomor NPWP PIC<span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <input type="text" id="nomor_npwp_pic" name="nomor_npwp_pic" class="form-control"
                            ...
                            <div
                                ...
                                <label for="alamat_pic">Alamat PIC<span class="text-danger">*</span></label>
                                <div class="input-group">
                                    {{-- <input type="text" id="alamat_pic" name="alamat_pic" class="form-control"
                                        value="{{ $data->data->alamat_pic }}" readonly /> --}}
                            ...
                            <div
                                ...
                                <label for="kabupaten_pic">Kota/Kabupaten PIC<span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <input type="text" id="kabupaten_pic" name="kabupaten_pic" class="form-control"
                            ...
                            <div
                                ...
                                <label for="kecamatan_pic">Kecamatan PIC<span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <input type="text" id="kecamatan_pic" name="kecamatan_pic" class="form-control"
                            ...
                            <div
                                ...
                                <label for="kelurahan_pic">Kelurahan PIC<span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <input type="text" id="kelurahan_pic" name="kelurahan_pic" class="form-control"
                                        value="{{ $data->data->kecamatan->name }}" readonly />
                                    <span class="input-group-addon">
                            ...
                            <div
                                ...
                                <label for="jenis_pekerjaan_id">Jenis Pekerjaan<span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <input type="text" id="jenis_pekerjaan_id" name="jenis_pekerjaan_id"
                                        class="form-control" value="{{ $data->data->jenis_pekerjaan->jenis_pekerjaan }}"
                                        readonly />
                                    <span class="input-group-addon">
                            ...
                            <div
                                ...
                                <div class="input-group">
                                    <input type="text" id="pendidikan_id" name="pendidikan_id" class="form-control"

...
@section('title', 'Buat Master Indikator')
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <ol class="breadcrumb pull-right">
                ...
                <li class="active">Buat Data Master Indikator</li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-md-6">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Buat Data Master Indikator</h3>
                </div>
                <div class="panel-body">
                    <form role="form" action="{{ route('master-indikator.store') }}" method="POST">
                        @csrf

...
@section('title', 'Buat Master Komponen RAB')

@section('content')
  <!-- Page-Title -->
  <div class="row">
    <div class="col-sm-12">
      <h4 class="pull-left page-title">KELOLA DATA Master Komponen RAB</h4>
      <ol class="breadcrumb pull-right">
        <li><a href="#">Data Master</a></li>
        <li><a href="{{ route('master-komponen-rab.index') }}">Forms</a></li>
        <li class="active">Pengelolaan Data Master Komponen RAB</li>
      </ol>
    </div>
  </div>
    ...
    <div class="col-md-6">
      <div class="panel panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title">Pengelolaan Data Master Komponen RAB</h3>
        </div>
        <div class="panel-body">
          <form role="form" action="{{ route('master-komponen-rab.store') }}" method="POST" autocomplete="off">
            @csrf
              ...
              <select class="form-control" id="jenis-komponen-rab" name="jenis_komponen_rab">
                ...
                @isset($JenisKomponenRab)
                  @foreach ($JenisKomponenRab as $item)
                    ...
                    @else
                      <option class='form-control' value="{{ $item['id'] }}">{{ $item['jenis_komponen_rab'] }}
                      </option>
                    @endif
                  @endforeach
                @endisset
              ...
              <select class="form-control" id="jenis-komponen-rab" name="satuan">
                ...
                @isset($Satuan)
                  @foreach ($Satuan as $item)
                    ...
                    @else
                      <option class='form-control' value="{{ $item['id'] }}">{{ $item['satuan'] }}
                      </option>
                    @endif
                  @endforeach
                @endisset
            ...
            <div class="form-group @error('master-komponen-rab') has-error @enderror">
              ...
              <input type="text" class="form-control" id="master-komponen-rab" name="master_komponen_rab"
                placeholder="Master Komponen RAB">
            ...
            <div class="form-group @error('standar-harga-unit') has-error @enderror">
              ...
              <input type="text" class="form-control" id="standar-harga-unit" name="standar_harga_unit"
                placeholder="Standar Harga Unit">

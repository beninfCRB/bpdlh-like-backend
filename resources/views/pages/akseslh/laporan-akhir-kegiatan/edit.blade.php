...
@section('title', 'Ubah Dokumen Laporan Akhir Kegiatan')
...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <h4 class="pull-left page-title">UBAH LAPORAN AKHIR KEGIATAN</h4>
            <ol class="breadcrumb pull-right">
                <li><a href="#">Pengajuan Kegiatan</a></li>
                <li class="active">Ubah Unggah Laporan Akhir Kegiatan</li>
            </ol>
        </div>
    </div>

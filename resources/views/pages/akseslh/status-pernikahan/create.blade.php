...
@section('title', 'Buat Status Pernikahan')
        ...
        <div class="col-md-6">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form role="form" action="{{ route('status-pernikahan.store') }}" method="POST">
                        @csrf
                        <div class="form-group @error('status_pernikahan') has-error @enderror">
                            ...
                            <input type="text" class="form-control" id="status_pernikahan" name="status_pernikahan"
                                placeholder="Status Pernikahan" value="{{ old('status_pernikahan') }}">

...
<div class="row">
    <div class="col-sm-12">
        <h4 class="pull-left page-title">Pengelolaan Data Jenis Kelompok Masyarakat</h4>
            ...
            <div class="panel-body">
                <form role="form" action="{{ route('jenis-kelompok-masyarakat.store') }}" method="POST">
                    ...
                    <div class="form-group @error('jenis_kelompok_masyarakat') has-error @enderror">
                        ...
                        <input type="text" class="form-control" id="jenis_kelompok_masyarakat" name="jenis_kelompok_masyarakat" placeholder="Jenis Kelompok Masyarakat" value="{{ $data->data->jenis_kelompok_masyarakat }}">
                        <input type="number" class="form-control" min=0 id="short_id" name="short_id value="{{ $data->data->short_id }}">

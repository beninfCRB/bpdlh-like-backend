...
@section('title', 'Edit Standar RAB Paket Kegiatan')

@section('content')
<!-- Page-Title -->
<div class="row">
    <div class="col-sm-12">
        <h4 class="pull-left page-title">KELOLA DATA Standar RAB Paket Kegiatan</h4>
        <ol class="breadcrumb pull-right">
            <li><a href="#">Data Master</a></li>
            <li><a href="#">Forms</a></li>
            <li class="active">Pengelolaan Data Standar RAB Paket Kegiatan</li>
        </ol>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">Pengelolaan Data Paket</h3>
            </div>
            <div class="panel-body">
                <div class="row">
                    <div class="form-group @error('jenis_kegiatan_id') has-error @enderror col-md-4">
                        ...
                        <select class="form-control" required id="jenis_kegiatan_id" name="jenis_kegiatan_id" required>
    ...
    <div class="col-md-12">
        <form action="{{ route('standar-rab-paket-kegiatan.store') }}" method="post">
            @csrf
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Standar RAB</h3>
                </div>
                <div class="panel-body">
                    <div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="checkbox" name="komponen_rab[id][]" id=""
                                                    value="{{ $item['id'] }}">
                                            </td>
                                            <td>{{ $item['komponen_rab'] }}</td>
                                            <td>{{ $item['standar_harga_unit'] }}</td>
                                            <td>
                                                <input type="number" class="form-control" name="komponen_rab[qty][]"
                                                    id="">
                                            </td>
                                            <td>
                                                <input type="number" class="form-control"
                                                    name="komponen_rab[harga_unit][]" id="">
                                            </td>
                                        </tr>
                                        @endforeach
                                        @endisset

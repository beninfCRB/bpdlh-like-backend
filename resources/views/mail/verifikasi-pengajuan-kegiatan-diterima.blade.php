...
<head>
    <meta charset="UTF-8">
    <title>Email Pengajuan Kegiatan Telah Diverifikasi</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>Pengajuan Kegiatan Telah Diverifikasi</h1>
        <p>
            Halo {{ $to->nama_pic }},
        </p>
        <p>
            Pengajuan anda dengan nomor {{ $data['nomor_pengajuan'] }} telah selesai diverifikasi,

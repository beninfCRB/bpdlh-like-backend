            ...
            return (
                (t =
                    "undefined" != typeof getComputedStyle
                        ? parseInt(
                              getComputedStyle(e).getPropertyValue("padding"),
                              10
                          )
                    ...
                    E = function (t) {
                        var n = t || e.event,
                            ...
                            i =
                                g.doneFunction &&
                                "true" ===
                                    B.getAttribute("data-has-done-function");
                        switch (n.type) {
                            case "mouseover":
                                r &&
                                    (o.style.backgroundColor = a(
                                        g.confirmButtonColor,
                                        -0.04
                                    ));
                                break;
                            case "mouseout":
                            ...
                            case "click":
                                if (r && i && s)
                                    ...
                                    var u = String(g.doneFunction).replace(
                                            /\s/g,
                                            ""
                                        ),
                                        f =
            ...
            (m = t.onclick),
                (t.onclick = function (t) {
                    var n = t || e.event,
                        ...
                        i =
                            "true" ===
                            B.getAttribute("data-allow-ouside-click");
                    !a && !r && s && i && v.close();
                });

...
var data_jenis_komponen_rab = (function () {
    var initTable1 = function () {
        var table = $("#dt_jenis_komponen_rab");
        var url_table = $("#data-table-jenis-komponen-rab").val();
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        <a data-id=` +
                            full.id +
                            ` href="#" onclick="deleteJenisKomponenRab(this,event)" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Hapus">

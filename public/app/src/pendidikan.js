...
var route = $("#pendidikan-route").val();

var data_pendidikan = (function () {
    var initTable1 = function () {
        var table = $("#dt_pendidikan");
        var url_table = $("#data-table-pendidikan").val();
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                       ...
                       <a href="` +
                        ...
                        <a data-id=` +
                            full.id +
                            ` href="#" onclick="deletePendidikan(this,event)" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Hapus">
...
jQuery(document).ready(function () {
    data_pendidikan.init();
});

window.deletePendidikan = (input) => {

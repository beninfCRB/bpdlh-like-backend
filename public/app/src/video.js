...
var route = $("#video-route").val();

var data_video = (function () {
    var initTable1 = function () {
        var table = $("#dt_video");
        var url_table = $("#data-table-video").val();
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                       ...
                       <a href="` +
                        ...
                        <a data-id=` +
                                full.id +
                                ` href="#" onclick="deleteVideo(this,event)" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Non Aktifkan">
                       ...
                       <a href="` +
                        ...
                        <a data-id=` +
                                full.id +
                                ` href="#" onclick="restoreVideo(this,event)" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Aktifkan">

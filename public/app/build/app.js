...
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'dayjs/locale/id'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'sweetalert2/src/sweetalert2.scss'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
window.select2 = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'select2'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
window.summernote = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'summernote'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
window.chartJs = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'chart.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
window.sendFiles = function (file, el) {
  var formData = new FormData();
  formData.append("file", file);
  axios.post('/upload/image', formData).then(function (res) {
    var image = $('<img>').attr('src', baseUrlAsset + res.data.data.file_path);
    $(el).summernote("insertNode", image[0]);
  })["catch"](function (err) {
    console.log(err);
  });
};
window.setupSummerNote = function (element) {
  $(element).summernote({
    insertTableMaxSize: {
      col: 200,
      row: 200
    ...
    ['style', ['bold', 'italic', 'underline', 'clear']], ['font', ['strikethrough', 'superscript', 'subscript']], ['fontsize', ['fontsize']], ['color', ['color']], ['para', ['ul', 'ol', 'paragraph', 'height']], ['insert', ['link', 'picture', 'video', 'table', 'hr']], ['fontname', ['fontname']], ['view', ['fullscreen', 'help']]],
    callbacks: {

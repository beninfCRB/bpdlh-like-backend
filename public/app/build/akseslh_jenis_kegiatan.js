    ...
    table.DataTable({
      ...
      columnDefs: [{
        ...
        render: function render(data, type, full, meta) {
          return "\n                       <a href=\"/career/" + full.id + "\" class=\"btn btn-sm btn-clean btn-icon btn-icon-md\" title=\"Detail\">\n                          <i class=\"fa fa-eye\"></i>\n                        </a>\n                        <a href=\"/akseslh/jenis-kegiatan/" + full.id + "/edit\" class=\"btn btn-sm btn-clean btn-icon btn-icon-md\" title=\"Ubah\">\n                          <i class=\"fa fa-pencil\"></i>\n                        </a>\n                        <a data-id=" + full.id + " href=\"#\" onclick=\"deleteJenisKegiatan(this,event)\" class=\"btn btn-sm btn-clean btn-icon btn-icon-md\" title=\"Hapus\">\n                          <i class=\"fa fa-trash\"></i>\n                        </a>";
        }
      }]
    });
  };
...
window.deleteJenisKegiatan = function (input) {
  Swal.fire({
    ...
    if (result.value) {
      (0,_api__WEBPACK_IMPORTED_MODULE_0__.deleteData)("/akseslh/jenis-kegiatan/" + $(input).attr("data-id")).then(function (res) {
